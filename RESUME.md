...
- [x] **Vercel 배포 완료(2026-08-04)** — https://walk-five.vercel.app 프로덕션 Ready. 폰 브라우저에서 바로 사용 가능(인증벽 해제됨). Env=`TMAP_APP_KEY` 3환경 등록. 리전 버그(icn→icn1) main 반영. ※CLI 직접 업로드 방식이라 git push 자동배포는 아직 미연결 — 원하면 Vercel 대시보드 Git 연동.
