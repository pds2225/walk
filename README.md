...
첫 방문에는 “개인정보 수집·이용 동의” 화면이 열려 있고, 항목이 미리 체크된 상태로
표시됩니다. 사용자는 [동의] 버튼만 누르면 되고, 원하지 않는 항목은 체크를 풀거나
[동의하지 않음]을 누를 수 있습니다. 체크 상태는 화면에만 있고 버튼을 누르기 전에는
아무것도 저장하지 않습니다. 동의 후에는 기존 상세 패널에서 항목별로 켜고 끌 수 있습니다.
